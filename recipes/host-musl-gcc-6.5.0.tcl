...
set rep_info [dict create \
	...
	make_flags "-j 3" \
	cd_dest $name-$ver \
	cfg_flags "--target=x86_64-pc-linux-musl --host=x86_64-pc-linux-musl --build=x86_64-pc-linux-musl --with-isl=$isl_dir --with-gmp=$gmp_dir --with-mpfr=$mpfr_dir --disable-multilib --with-mpc=$mpc_dir" \
	cfg_type "at-new-dir" \
]
