...
set rep_info [dict create \
	...
	make_flags "-j 3" \
	cd_dest $name-$ver \
	cfg_flags "CFLAGS='-pipe -g0' CXXFLAGS='-pipe -g0' --target=$arch-pc-linux-musl --host=$arch-pc-linux-musl --build=$arch-pc-linux-musl --with-isl=$isl_dir --with-gmp=$gmp_dir --with-mpfr=$mpfr_dir --disable-multilib --with-mpc=$mpc_dir" \
	cfg_type "at-new-dir" \
]
